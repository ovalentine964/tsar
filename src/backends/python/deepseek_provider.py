...
Tier 3 provider for deep reasoning tasks (trade narratives, strategy synthesis).
Uses the OpenAI-compatible API format provided by DeepSeek.
"""
...
class DeepSeekProvider(LLMProvider):
    ...
    async def stream(self, prompt: str, **kwargs: Any) -> AsyncIterator[LLMChunk]:
        """Stream a response from DeepSeek chunk by chunk.
