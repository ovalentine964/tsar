"""
TSAR Session Manager — Tracks current trading session and liquidity behavior.
...
class SessionManager:
    ...
    def current_session(self, now: datetime | None = None) -> SessionInfo:
        """Alias for get_session_info() used by EntryPipeline and TSARStrategy."""
        return self.get_session_info(now)
